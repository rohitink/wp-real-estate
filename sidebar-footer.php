 ...
 */
 ...
 <?php if ( is_active_sidebar('wpre-footer-1') || is_active_sidebar('wpre-footer-2') || is_active_sidebar('wpre-footer-3') || is_active_sidebar('wpre-footer-4') ) : ?>
	 <div id="footer-sidebar" class="widget-area">
	 	<div class="container">
		 	<?php 
				...
				if ( is_active_sidebar( 'wpre-footer-4' ) ) : ?>
					<div class="footer-column col-md-3 col-sm-6"> <?php
						dynamic_sidebar( 'wpre-footer-4'); ?> 
					</div>
				<?php endif; ?>
